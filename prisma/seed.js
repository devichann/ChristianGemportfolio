...
async function main() {
  ...
  try {
    ...
    for (const person of seedData) {
      await client.query(
        'INSERT INTO "Person" ("firstName", "lastName", "email", "jobTitle", "department", "avatarUrl", "createdAt", "updatedAt") VALUES ($1, $2, $3, $4, $5, $6, NOW(), NOW())',
        [person.firstName, person.lastName, person.email, person.jobTitle, person.department, person.avatarUrl]
      );
    }
